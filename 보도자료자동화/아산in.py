...
def asanin35(input):
    ...
    url = "http://www.asanin.kr/news/articleList.html"

    headers = {
        "Referer" : "http://www.asanin.kr/",
    ...
    if cnt > 0:
        ...
        driver.implicitly_wait(5)
        driver.find_element(By.XPATH,'//*[@id="user-container"]/div[3]/header/section/ul/li[8]/button').send_keys(Keys.ENTER)
        #time.sleep(5)
