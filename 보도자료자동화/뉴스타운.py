...
def newstown38(input):
    ...
    url = "http://www.newstown.co.kr/news/articleList.html"

    headers = {
        "Referer" : "http://www.newstown.co.kr/news/articleList.html",
    ...
    if cnt > 0:
        ...
        driver.get("http://www.newstown.co.kr/")
        time.sleep(1)
        ...
        driver.implicitly_wait(5)
        driver.find_element(By.XPATH,'//*[@id="user-container"]/div[3]/header/section/div[2]/ul/li[2]/button').send_keys(Keys.ENTER)
        #time.sleep(5)
