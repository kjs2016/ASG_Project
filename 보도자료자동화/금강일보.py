...
def ggilbo17(input):
    ...
    url = 'http://prt.ggilbo.com/engine_yonhap/search.php?picktab=all&searchcont=yonhap&div_code=&others_cont_type=&orgsearchword=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8&page=1&sort=&from_date=&to_date=&searchword2=&searchword=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8'
    ...
    if cnt > 0:
        ...
        driver.get("http://prt.ggilbo.com/engine_yonhap/search.php?picktab=all&searchcont=yonhap&div_code=&others_cont_type=&orgsearchword=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8&page=1&sort=&from_date=&to_date=&searchword2=&searchword=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8")
        ...
        driver.find_element(By.XPATH,'//*[@id="article-view"]/div/header/div/article[2]/div/div/button[1]').send_keys(Keys.ENTER)
        #try:
