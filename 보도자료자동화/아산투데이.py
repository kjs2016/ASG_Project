...
def asnatoday4(input):
    ...
    #아산투데이
    url = 'https://www.asantoday.com/search.html?submit=submit&search_and=1&search_exec=all&search_section=all&news_order=1&search=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8&imageField.x=0&imageField.y=0'
    ...
    if cnt > 0:
        ...
        driver.get("https://www.asantoday.com/search.html?submit=submit&search_and=1&search_exec=all&search_section=all&news_order=1&search=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8&imageField.x=0&imageField.y=0")
       ...
       # for i in range(len(new_date_array)):
        ...
        time.sleep(2)
        driver.find_element(By.XPATH,'//*[@id="wrap"]/div[4]/div[2]/div[3]/ul/li[2]/a').send_keys(Keys.ENTER)
        #time.sleep(5)
