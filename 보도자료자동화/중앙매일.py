...
def jamill22(input):
    ...
    url = "http://www.jamill.kr/news/articleList.html"

    headers = {
        "Referer" : "http://www.jamill.kr/news/articleList.html",
    ...
    if cnt > 0:
        ...
        if(num == 1):
            driver.find_element(By.XPATH,'//*[@id="user-container"]/div[3]/div[2]/section/article/div[2]/section/div[1]/div[1]/a').click()#첫번째 기사 클릭
        elif(num == 2):
             driver.find_element(By.XPATH, '//*[@id="user-container"]/div[3]/div[2]/section/article/div[2]/section/div[2]/div[1]/a').click()#기사 2번째 클릭
        elif(num == 3):
        ...
        driver.implicitly_wait(5)
        driver.find_element(By.XPATH,'//*[@id="user-container"]/div[3]/header/section/ul/li[7]/button').send_keys(Keys.ENTER)
        #time.sleep(5)
