...
def newscj20(input):
    ...
    url = 'https://www.newscj.com/news/articleList.html?sc_area=A&view_type=sm&sc_word=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8'

    response = requests.get(url)
    soup = BeautifulSoup(response.content, 'html.parser')

    title_array = soup.find_all("h2","titles")
    #titles = ul.select('a')
    ...
    if cnt > 0:
        ...
        driver.get("https://www.newscj.com/news/articleList.html?sc_area=A&view_type=sm&sc_word=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8")
        driver.implicitly_wait(5)
        req = driver.page_source
        soup = BeautifulSoup(req, 'html.parser')

        if(num == 1):
            driver.find_element(By.XPATH, '//*[@id="section-list"]/ul/li[1]/div/h2/a').send_keys(Keys.ENTER)#기사 1번째 클릭
        elif(num == 2):
            driver.find_element(By.XPATH, '//*[@id="section-list"]/ul/li[2]/div/h2/a').send_keys(Keys.ENTER)#기사 2번째 클릭
        elif(num == 3):
            driver.find_element(By.XPATH, '//*[@id="section-list"]/ul/li[3]/div/h2/a').send_keys(Keys.ENTER)
        elif(num == 4):
            driver.find_element(By.XPATH, '//*[@id="section-list"]/ul/li[4]/div/h4/a').send_keys(Keys.ENTER)
        elif(num == 5):
            driver.find_element(By.XPATH, '//*[@id="section-list"]/ul/li[5]/div/h4/a').send_keys(Keys.ENTER)
        elif(num == 6):
            driver.find_element(By.XPATH, '//*[@id="section-list"]/ul/li[6]/div/h4/a').send_keys(Keys.ENTER)
        elif(num == 7):
            driver.find_element(By.XPATH, '//*[@id="section-list"]/ul/li[7]/div/h4/a').send_keys(Keys.ENTER)
        else:
        ...
        time.sleep(2)
        driver.find_element(By.XPATH,'//*[@id="articleViewCon"]/article/header/div/article[2]/section[2]/button[1]').send_keys(Keys.ENTER)
        #time.sleep(5)
