...
def cc(input):
    ...
    url = 'https://www.dailycc.net/news/articleList.html?sc_area=A&view_type=sm&sc_word=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8'
    ...
    if cnt > 0:
        ...
        driver.implicitly_wait(5)
        driver.find_element(By.XPATH,'//*[@id="articleViewCon"]/article/div[2]/article/button[5]').send_keys(Keys.ENTER)
        #time.sleep(5)
