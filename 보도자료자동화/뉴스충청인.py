...
def cndnews31(input):
    ...
    url = 'http://www.cndnews.co.kr/search.html?submit=submit&search=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8&imageField3.x=18&imageField3.y=8&search_and=1&search_exec=all&search_section=all&news_order=1&search_start_day=&search_end_day=20230517'
    ...
    if cnt > 0:
        ...
        driver.get("http://www.cndnews.co.kr/search.html?submit=submit&search=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8&imageField3.x=18&imageField3.y=8&search_and=1&search_exec=all&search_section=all&news_order=1&search_start_day=&search_end_day=20230517")
       ...
       # for i in range(len(new_date_array)):
        ...
        time.sleep(2)
        driver.find_element(By.XPATH,'//*[@id="article_head"]/div[3]/div/div[2]/ul/li[1]/a').send_keys(Keys.ENTER)
        #time.sleep(5)
