...
def chungnamin40(input):
    ...
    url = "http://www.chungnamin.co.kr/news/articleList.html"

    headers = {
        "Referer" : "http://www.chungnamin.co.kr/news/articleList.html",
    ...
    if cnt > 0:
        ...
        driver.get("http://www.chungnamin.co.kr/")
        time.sleep(1)

        #driver.find_element(By.XPATH, '//*[@id="userSearch"]/button').click()
        ...
        if(num == 1):
            driver.find_element(By.XPATH,'//*[@id="section-list"]/ul/li[1]/h4/a').send_keys(Keys.ENTER)#첫번째 기사 클릭
        elif(num == 2):
             driver.find_element(By.XPATH, '//*[@id="section-list"]/ul/li[2]/h4/a').send_keys(Keys.ENTER)#기사 2번째 클릭
        elif(num == 3):
             driver.find_element(By.XPATH, '//*[@id="section-list"]/ul/li[3]/div/h4/a').send_keys(Keys.ENTER)#기사 3번째 클릭
        elif(num == 4):
            driver.find_element(By.XPATH, '//*[@id="section-list"]/ul/li[4]/div/h4/a').send_keys(Keys.ENTER)#기사 4번째 클릭
        elif(num == 5):
            driver.find_element(By.XPATH, '//*[@id="section-list"]/ul/li[5]/div/h4/a').send_keys(Keys.ENTER)#기사 5번째 클릭
        else:
            print("그냥 진행합시다")
