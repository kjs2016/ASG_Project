...
def asandaily27(input):
    ...
    url = 'http://asandaily.kr/List.aspx?TYPE=00&TEXT=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8'
    ...
    if cnt > 0:
        ...
        driver.get("http://asandaily.kr/List.aspx?TYPE=00&TEXT=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8")
        driver.implicitly_wait(5)
        req = driver.page_source
        soup = BeautifulSoup(req, 'html.parser')

        if(num == 1):
            driver.find_element(By.XPATH, '//*[@id="ulListType"]/li[1]/a').send_keys(Keys.ENTER)#기사 1번째 클릭
        elif(num == 2):
             driver.find_element(By.XPATH, '//*[@id="ulListType"]/li[2]/a').send_keys(Keys.ENTER)#기사 2번째 클릭
        elif(num == 3):
             driver.find_element(By.XPATH, '//*[@id="ulListType"]/li[3]/a').send_keys(Keys.ENTER)#기사 3번째 클릭
        elif(num == 4):
             driver.find_element(By.XPATH, '//*[@id="ulListType"]/li[4]/a').send_keys(Keys.ENTER)#기사 4번째 클릭
        elif(num == 5):
             driver.find_element(By.XPATH, '//*[@id="ulListType"]/li[5]/a').send_keys(Keys.ENTER)#기사 5번째 클릭
        elif(num == 6):
            driver.find_element(By.XPATH, '//*[@id="ulListType"]/li[6]/a').send_keys(Keys.ENTER)#기사 5번째 클릭
        elif(num == 7):
            driver.find_element(By.XPATH, '//*[@id="ulListType"]/li[7]/a').send_keys(Keys.ENTER)#기사 5번째 클릭
        else:
        ...
        time.sleep(2)
        #driver.find_element(By.XPATH,'//*[@id="article-view"]/div/header/div[2]/article[2]/div[2]/button[1]').send_keys(Keys.ENTER)
        #time.sleep(5)
