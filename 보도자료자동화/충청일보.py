...
def ccdailynews14(input):
    ...
    url = 'https://prt.ccdailynews.com/engine_yonhap/search.php?picktab=all&searchcont=yonhap&div_code=&others_cont_type=&orgsearchword=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8&page=1&sort=&from_date=&to_date=&searchword2=&searchword=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8'
    ...
    if cnt > 0:
        ...
        driver.get("https://prt.ccdailynews.com/engine_yonhap/search.php?picktab=all&searchcont=yonhap&div_code=&others_cont_type=&orgsearchword=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8&page=1&sort=&from_date=&to_date=&searchword2=&searchword=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8")
        driver.implicitly_wait(5)
        req = driver.page_source
        soup = BeautifulSoup(req, 'html.parser')

        if(num == 1):
            driver.find_element(By.XPATH, '//*[@id="search_result"]/div[1]/div[2]/div[1]/div/div/a').send_keys(Keys.ENTER)#기사 1번째 클릭
        elif(num == 2):
            driver.find_element(By.XPATH, '//*[@id="search_result"]/div[1]/div[2]/div[2]/div[2]/div/a').send_keys(Keys.ENTER)#기사 2번째 클릭
        elif(num == 3):
            driver.find_element(By.XPATH, '//*[@id="search_result"]/div[1]/div[2]/div[3]/div/div/a').send_keys(Keys.ENTER)
        elif(num == 4):
            driver.find_element(By.XPATH, '//*[@id="search_result"]/div[1]/div[2]/div[4]/div/div/a').send_keys(Keys.ENTER)
        else:
            print("그냥 진행합시다")
