...
def asandesk26(input):
    ...
    url = "http://www.asandesk.co.kr/news/articleList.html"

    headers = {
        "Referer" : "http://www.asandesk.co.kr/news/articleList.html",
    ...
    if cnt > 0:
        ...
        driver.get("http://www.asandesk.co.kr/")
        time.sleep(1)

        #driver.find_element(By.XPATH, '//*[@id="nav-header"]/div/div/div[3]/div[2]/button').click()
        ...
        if(num == 1):
            driver.find_element(By.XPATH,'//*[@id="user-container"]/div[3]/div[2]/section/article/div[2]/section/div[1]/div[2]/a').click()#첫번째 기사 클릭
        elif(num == 2):
             driver.find_element(By.XPATH, '//*[@id="user-container"]/div[3]/div[2]/section/article/div[2]/section/div[2]/div[2]/a').click()#기사 2번째 클릭
        elif(num == 3):
             driver.find_element(By.XPATH, '//*[@id="user-container"]/div[3]/div[2]/section/article/div[2]/section/div[3]/div[1]/a').send_keys(Keys.ENTER)#기사 3번째 클릭
        elif(num == 4):
            driver.find_element(By.XPATH, '//*[@id="user-container"]/div[3]/div[2]/section/article/div[2]/section/div[4]/div[1]/a').send_keys(Keys.ENTER)#기사 4번째 클릭
        elif(num == 5):
            driver.find_element(By.XPATH, '//*[@id="user-container"]/div[3]/div[2]/section/article/div[2]/section/div[5]/div[1]/a').send_keys(Keys.ENTER)#기사 5번째 클릭
        else:
            print("그냥 진행합시다")
