...
def cctoday11(input):
    ...
    url = 'https://prt.cctoday.co.kr/engine_yonhap/search.php?sc_area=A&view_type=sm&sc_word=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8&_ga=2.247582213.322912265.1683534552-73037611.1681804658'
    ...
    if cnt > 0:
        ...
        driver.get("https://prt.cctoday.co.kr/engine_yonhap/search.php?sc_area=A&view_type=sm&sc_word=%EC%95%84%EC%82%B0%EC%8B%9C%EC%8B%9C%EC%84%A4%EA%B4%80%EB%A6%AC%EA%B3%B5%EB%8B%A8&_ga=2.247582213.322912265.1683534552-73037611.1681804658")
        driver.implicitly_wait(5)
        req = driver.page_source
        soup = BeautifulSoup(req, 'html.parser')

        if(num == 1):
            driver.find_element(By.XPATH, '//*[@id="search_result"]/div[1]/div[2]/div[1]/div[2]/div/a').click()#기사 1번째 클릭
        elif(num == 2):
            driver.find_element(By.XPATH, '//*[@id="search_result"]/div[1]/div[2]/div[2]/div[2]/div/a').click()#기사 2번째 클릭
        elif(num == 3):
            driver.find_element(By.XPATH, '//*[@id="search_result"]/div[1]/div[2]/div[3]/div[2]/div/a').click()#기사 3번째 클릭
        elif(num == 4):
            driver.find_element(By.XPATH, '//*[@id="search_result"]/div[1]/div[2]/div[4]/div[2]/div/a').click()#기사 4번째 클릭
        elif(num == 5):
            driver.find_element(By.XPATH, '//*[@id="search_result"]/div[1]/div[2]/div[5]/div[2]/div/a').click()#기사 5번째 클릭
        elif(num == 6):
        ...
        time.sleep(2)
        #driver.find_element(By.XPATH,'//*[@id="hide-sns"]/button[6]').send_keys(Keys.ENTER)
        try:
